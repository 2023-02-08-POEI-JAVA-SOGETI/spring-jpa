...
public class FournisseurServiceTest {
	...
	public void testSaveGet() throws FournisseurException {
		// Je prépare mes données
				...
				Fournisseur fournisseurSauvegarde = this.fournisseurService.sauvegarde(fournisseur);
	...
	public void testDelete() throws FournisseurException {
		Fournisseur fournisseur = new Fournisseur();
		Fournisseur fournisseurSauvegarde = this.fournisseurService.sauvegarde(fournisseur);
		this.fournisseurService.supprimer(fournisseurSauvegarde.getId());
	...
	public void testUpdate() throws FournisseurException {
		...
		//Act
		fournisseurSauvegarde = this.fournisseurService.sauvegarde(fournisseurSauvegarde);
